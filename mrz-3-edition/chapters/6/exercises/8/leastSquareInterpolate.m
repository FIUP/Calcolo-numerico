function [coeffs] = leastSquareInterpolate(x, y, w, n)
% LEASTSQUAREINTERPOLATE Interpolate points (with weights) and find the
% least-square polynomial fitting.
%
%  [coeffs] = leastSquareInterpolate(x, y, w, n)
%
% Creates linear system Ax = b (A'A x = A'b) to find polynomial.
%
% Input:
